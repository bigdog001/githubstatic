const sutra_en_58_1 = `1 In the past God spoke to our ancestors through the prophets at many times and in various ways,
...
const sutra_en_58_2 = `1 We must pay the most careful attention, therefore, to what we have heard, so that we do not drift away.
...
const sutra_en_58_3 = `1 Therefore, holy brothers and sisters, who share in the heavenly calling, fix your thoughts on Jesus, whom we acknowledge as our apostle and high priest.
...
const sutra_en_58_4 = `1 Therefore, since the promise of entering his rest still stands, let us be careful that none of you be found to have fallen short of it.
...
const sutra_en_58_5 = `1 Every high priest is selected from among the people and is appointed to represent the people in matters related to God, to offer gifts and sacrifices for sins.
...
const sutra_en_58_6 = `1 Therefore let us move beyond the elementary teachings about Christ and be taken forward to maturity, not laying again the foundation of repentance from acts that lead to death, and of faith in God,
...
const sutra_en_58_7 = `1 This Melchizedek was king of Salem and priest of God Most High. He met Abraham returning from the defeat of the kings and blessed him,
...
const sutra_en_58_8 = `1 Now the main point of what we are saying is this: We do have such a high priest, who sat down at the right hand of the throne of the Majesty in heaven,
...
const sutra_en_58_9 = `1 Now the first covenant had regulations for worship and also an earthly sanctuary.
...
const sutra_en_58_10 = `1 The law is only a shadow of the good things that are coming—not the realities themselves. For this reason it can never, by the same sacrifices repeated endlessly year after year, make perfect those who draw near to worship.
...
const sutra_en_58_11 = `1 Now faith is confidence in what we hope for and assurance about what we do not see.
...
const sutra_en_58_12 = ` 1 Therefore, since we are surrounded by such a great cloud of witnesses, let us throw off everything that hinders and the sin that so easily entangles. And let us run with perseverance the race marked out for us,
...
const sutra_en_58_13 = `1 Keep on loving one another as brothers and sisters.
...
const sutra_en_58 = [sutra_en_58_1,sutra_en_58_2,sutra_en_58_3,sutra_en_58_4,sutra_en_58_5,sutra_en_58_6,sutra_en_58_7,sutra_en_58_8,sutra_en_58_9,sutra_en_58_10,
                sutra_en_58_11,sutra_en_58_12,sutra_en_58_13 ];

const sutra_en_21_1 = `1 The words of the Teacher, son of David, king in Jerusalem:
...
const sutra_en_21_2 = `1 I said to myself, “Come now, I will test you with pleasure to find out what is good.” But that also proved to be meaningless.
...
const sutra_en_21_3 = `1 There is a time for everything, and a season for every activity under the heavens:
...
const sutra_en_21_4 = `1 Again I looked and saw all the oppression that was taking place under the sun: I saw the tears of the oppressed— and they have no comforter; power was on the side of their oppressors— and they have no comforter.
...
const sutra_en_21_5 = ` 1 Guard your steps when you go to the house of God. Go near to listen rather than to offer the sacrifice of fools, who do not know that they do wrong.
...
const sutra_en_21_6 = `1 I have seen another evil under the sun, and it weighs heavily on mankind:
...
const sutra_en_21_7 = `1 A good name is better than fine perfume, and the day of death better than the day of birth.
...
const sutra_en_21_8 = ` 1 Who is like the wise? Who knows the explanation of things? A person’s wisdom brightens their face and changes its hard appearance.
...
const sutra_en_21_9 = `1 So I reflected on all this and concluded that the righteous and the wise and what they do are in God’s hands, but no one knows whether love or hate awaits them.
...
const sutra_en_21_10 = `1 As dead flies give perfume a bad smell, so a little folly outweighs wisdom and honor.
...
const sutra_en_21_11 = `1 Ship your grain across the sea; after many days you may receive a return.
...
const sutra_en_21_12 = `1 Remember your Creator in the days of your youth, before the days of trouble come and the years approach when you will say, “I find no pleasure in them”—

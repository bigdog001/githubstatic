const sutra_en_27_1 = `1 In the third year of the reign of Jehoiakim king of Judah, Nebuchadnezzar king of Babylon came to Jerusalem and besieged it.
...
const sutra_en_27_2 = `1 In the second year of his reign, Nebuchadnezzar had dreams; his mind was troubled and he could not sleep.
...
const sutra_en_27_3 = `1 King Nebuchadnezzar made an image of gold, sixty cubits high and six cubits wide, and set it up on the plain of Dura in the province of Babylon.
...
const sutra_en_27_4 = `1 King Nebuchadnezzar, To the nations and peoples of every language, who live in all the earth: May you prosper greatly!
...
const sutra_en_27_5 = `1 King Belshazzar gave a great banquet for a thousand of his nobles and drank wine with them.
...
const sutra_en_27_6 = `1 It pleased Darius to appoint 120 satraps to rule throughout the kingdom,
...
const sutra_en_27_7 = `1 In the first year of Belshazzar king of Babylon, Daniel had a dream, and visions passed through his mind as he was lying in bed. He wrote down the substance of his dream.
...
const sutra_en_27_8 = `1 In the third year of King Belshazzar’s reign, I, Daniel, had a vision, after the one that had already appeared to me.
...
const sutra_en_27_9 = `1 In the first year of Darius son of Xerxes (a Mede by descent), who was made ruler over the Babylonian kingdom—
...
const sutra_en_27_10 = `1 In the third year of Cyrus king of Persia, a revelation was given to Daniel (who was called Belteshazzar). Its message was true and it concerned a great war. The understanding of the message came to him in a vision.
...
const sutra_en_27_11 = `1 And in the first year of Darius the Mede, I took my stand to support and protect him.)
...
const sutra_en_27_12 = `1 “At that time Michael, the great prince who protects your people, will arise. There will be a time of distress such as has not happened from the beginning of nations until then. But at that time your people—everyone whose name is found written in the book—will be delivered.

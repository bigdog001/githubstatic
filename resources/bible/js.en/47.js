const sutra_en_47_1 = `1 Paul, an apostle of Christ Jesus by the will of God, and Timothy our brother, To the church of God in Corinth, together with all his holy people throughout Achaia:
...
const sutra_en_47_2 = `1 So I made up my mind that I would not make another painful visit to you.
...
const sutra_en_47_3 = `1 Are we beginning to commend ourselves again? Or do we need, like some people, letters of recommendation to you or from you?
...
const sutra_en_47_4 = `1 Therefore, since through God’s mercy we have this ministry, we do not lose heart.
...
const sutra_en_47_5 = `1 For we know that if the earthly tent we live in is destroyed, we have a building from God, an eternal house in heaven, not built by human hands.
...
const sutra_en_47_6 = `1 As God’s co-workers we urge you not to receive God’s grace in vain.
...
const sutra_en_47_7 = `1 Therefore, since we have these promises, dear friends, let us purify ourselves from everything that contaminates body and spirit, perfecting holiness out of reverence for God.
...
const sutra_en_47_8 = `1 And now, brothers and sisters, we want you to know about the grace that God has given the Macedonian churches.
...
const sutra_en_47_9 = `1 There is no need for me to write to you about this service to the Lord’s people.
...
const sutra_en_47_10 = `1 By the humility and gentleness of Christ, I appeal to you—I, Paul, who am “timid” when face to face with you, but “bold” toward you when away!
...
const sutra_en_47_11 = `1 I hope you will put up with me in a little foolishness. Yes, please put up with me!
...
const sutra_en_47_12 = `1 I must go on boasting. Although there is nothing to be gained, I will go on to visions and revelations from the Lord.
...
const sutra_en_47_13 = `1 This will be my third visit to you. “Every matter must be established by the testimony of two or three witnesses.”
...
const sutra_en_47 = [sutra_en_47_1,sutra_en_47_2,sutra_en_47_3,sutra_en_47_4,sutra_en_47_5,sutra_en_47_6,sutra_en_47_7,sutra_en_47_8,sutra_en_47_9,sutra_en_47_10,
                sutra_en_47_11,sutra_en_47_12,sutra_en_47_13 ];

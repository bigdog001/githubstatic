const sutra_18_1 = `1 乌斯地有一个人名叫约伯。那人完全正直，敬畏神，远离恶事。
2 他生了七个儿子，三个女儿。
...
const sutra_18_2 = `1 又有一天，神的众子来侍立在耶和华面前，撒但也来在其中。
...
const sutra_18_3 = `1 此后，约伯开口咒诅自己的生日，
...
const sutra_18_5 = `1 你且呼求，有谁答应你？诸圣者之中，你转向哪一位呢？
2 忿怒害死愚妄人，嫉妒杀死痴迷人。
...
const sutra_18_7 = `1 人在世上岂无争战吗？他的日子不像雇工人的日子吗？
2 像奴仆切慕黑影，像雇工人盼望工价。
...
const sutra_18_10 = `1 我厌烦我的性命，必由着自己述说我的哀情。因心里苦恼，我要说话。
...
const sutra_18_13 = `1 这一切，我眼都见过。我耳都听过，而且明白。
...
28 我已经像灭绝的烂物，像虫蛀的衣裳 `;
const sutra_18_14 = `1 人为妇人所生，日子短少，多有患难。
...
const sutra_18_17 = `1 的心灵消耗，我的日子灭尽。坟墓为我预备好了。
...
const sutra_18_24 = `1 能者既定期罚恶，为何不使认识他的人看见那日子呢？
2 有人挪移地界，抢夺群畜而牧养。
...
const sutra_18_30 = `1 如今，比我年少的人戏笑我。其人之父我曾藐视，不肯安在看守我羊群的狗中。
...
const sutra_18_31 = `1 与眼睛立约，怎能恋恋瞻望处女呢？
...
const sutra_18_32 = `1 于是这三个人，因约伯自以为义就不再回答他。
...
const sutra_18_33 = `1 伯啊，请听我的话，留心听我一切的言语。
2 我现在开口，用舌发言。
...
const sutra_18_37 = `1 因此我心战兢，从原处移动。
...
const sutra_18_38 = `1 那时，耶和华从旋风中回答约伯说，
2 谁用无知的言语，使我的旨意暗昧不明。
...
const sutra_18_41 = `1 你能用鱼钩钓上鳄鱼吗？能用绳子压下它的舌头吗？
...
10 约伯为他的朋友祈祷。耶和华就使约伯从苦境转回（苦境原文作掳掠），并且耶和华赐给他的，比他从前所有的加倍。
...
15 在那全地的妇女中，找不着像约伯的女儿那样美貌。她们的父亲使她们在弟兄中得产业。

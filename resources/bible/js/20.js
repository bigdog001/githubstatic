const sutra_20_1 = `1 以色列王大卫儿子所罗门的箴言。
...
const sutra_20_2 = `1 我儿，你若领受我的言语，存记我的命令，
2 侧耳听智慧，专心求聪明。
3 呼求明哲，扬声求聪明，
...
22 惟有恶人必然剪除。奸诈的必然拔出 `;
const sutra_20_3 = `1 我儿，不要忘记我的法则。（或作指教）你心要谨守我的诫命。
...
const sutra_20_4 = `1 众子啊，要听父亲的教训，留心得知聪明。
...
26 要修平你脚下的路，坚定你一切的道。
27 不可偏向左右。要使你的脚离开邪恶 `;
const sutra_20_5 = `1 我儿，要留心我智慧的话语，侧耳听我聪明的言词。
2 为要使你谨守谋略，嘴唇保存知识。
...
const sutra_20_7 = `1 我儿，你要遵守我的言语，将我的命令存记在心。
...
27 她的家是在阴间之路，下到死亡之宫 `;
const sutra_20_8 = `1 慧岂不呼叫，聪明岂不发声。
2 他在道旁高处的顶上，在十字路口站立。
...
const sutra_20_9 = `1 智慧建造房屋，凿成七根柱子，
2 宰杀牲畜，调和旨酒，设摆筵席。
3 打发使女出去，自己在城中至高处呼叫，
...
const sutra_20_10 = `1 所罗门的箴言。智慧之子，使父亲欢乐。愚昧之子，叫母亲担忧。
...
const sutra_20_11 = `1 诡诈的天平，为耶和华所憎恶。公平的法码，为他所喜悦。
2 骄傲来，羞耻也来。谦逊人却有智慧。
...
const sutra_20_12 = `1 爱管教的，就是喜爱知识。恨恶责备的，却是畜类。
...
const sutra_20_13 = `1 智慧子听父亲的教训。亵慢人不听责备。
...
25 义人吃得饱足。恶人肚腹缺粮。 `;
const sutra_20_14 = `1 智慧妇人，建立家室。愚妄妇人，亲手拆毁。
...
const sutra_20_15 = `1 回答柔和，使怒消退。言语暴戾，触动怒气。
...
const sutra_20_16 = `1 心中的谋算在乎人。舌头的应对，由于耶和华。
...
33 签放在怀里。定事由耶和华 `;
const sutra_20_17 = `1 设筵满屋，大家相争，不如有块干饼，大家相安。
...
const sutra_20_18 = `1 与众寡合的，独自寻求心愿，并恼恨一切真智慧。
2 愚昧人不喜爱明哲，只喜爱显露心意。
3 恶人来，藐视随来。羞耻到，辱骂同到。
...
const sutra_20_19 = `1 为纯正的贫穷人，胜过乖谬愚妄的富足人。
...
const sutra_20_20 = `1 酒能使人亵慢，浓酒使人喧嚷。凡因酒错误的，就无智慧。
...
const sutra_20_21 = `1 王的心在耶和华手中，好像陇沟的水，随意流转。
...
const sutra_20_22 = `1 美名胜过大财，恩宠强如金银。
2 富户穷人，在世相遇，都为耶和华所造。
3 通达人见祸藏躲。愚蒙人前往受害。
...
const sutra_20_23 = `1 你若与官长坐席，要留意在你面前的是谁。
2 你若是贪食的，就当拿刀放在喉咙上。
3 不可贪恋他的美食，因为是哄人的食物。
4 不要劳碌求富。休仗自己的聪明。
...
12 你若说，这事我未曾知道。那衡量人心的，岂不明白吗？保守你命的，岂不知道吗？他岂不按各人所行的，报应各人吗？
...
const sutra_20_25 = `1 以下也是所罗门的箴言。是犹大王希西家的人所誊录的。
...
const sutra_20_26 = `1 夏天落雪，收割时下雨，都不相宜。愚昧人得尊荣，也是如此。
...
18 人欺凌邻舍，却说，我岂不是戏耍吗？他就像疯狂的人，抛掷火把，利箭
19 与杀人的兵器。（杀人的兵器原文作死亡）
...
const sutra_20_27 = `1 要为明日自夸，因为一日要生何事，你尚且不能知道。
...
const sutra_20_28 = `1 恶人虽无人追赶也逃跑，义人却胆壮像狮子。
...
const sutra_20_29 = `1 人屡次受责罚，仍然硬着颈项，他必顷刻败坏，无法可治。
...
const sutra_20_30 = `1 基的儿子亚古珥的言语， 就是真言。 这人对以铁和乌甲说，
2 我比众人更蠢笨， 也没有人的聪明。
3 我没有学好智慧。 也不认识至圣者。
...
const sutra_20_31 = `1 利慕伊勒王的言语，是他母亲教训他的真言。
...
const sutra_20 = [sutra_20_1,sutra_20_2,sutra_20_3,sutra_20_4,sutra_20_5,sutra_20_6,sutra_20_7,sutra_20_8,sutra_20_9,sutra_20_10,
                sutra_20_11,sutra_20_12,sutra_20_13,sutra_20_14,sutra_20_15,sutra_20_16,sutra_20_17,sutra_20_18,sutra_20_19,sutra_20_20,
                sutra_20_21,sutra_20_22,sutra_20_23,sutra_20_24,sutra_20_25,sutra_20_26,sutra_20_27,sutra_20_28,sutra_20_29,sutra_20_30,
                sutra_20_31
                ];

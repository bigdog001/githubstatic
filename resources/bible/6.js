const sutra_en_6_1 = `1 After the death of Moses the servant of the LORD, the LORD said to Joshua son of Nun, Moses’ aide:
...
const sutra_en_6_2 = `1 Then Joshua son of Nun secretly sent two spies from Shittim. “Go, look over the land,” he said, “especially Jericho.” So they went and entered the house of a prostitute named Rahab and stayed there.
...
const sutra_en_6_3 = `1 Early in the morning Joshua and all the Israelites set out from Shittim and went to the Jordan, where they camped before crossing over.
...
const sutra_en_6_4 = `1 When the whole nation had finished crossing the Jordan, the LORD said to Joshua,
...
const sutra_en_6_5 = `1 Now when all the Amorite kings west of the Jordan and all the Canaanite kings along the coast heard how the LORD had dried up the Jordan before the Israelites until they had crossed over, their hearts melted in fear and they no longer had the courage to face the Israelites.
...
const sutra_en_6_6 = `1 Now the gates of Jericho were securely barred because of the Israelites. No one went out and no one came in.
...
const sutra_en_6_7 = `1 But the Israelites were unfaithful in regard to the devoted things ; Achan son of Karmi, the son of Zimri, the son of Zerah, of the tribe of Judah, took some of them. So the LORD’s anger burned against Israel.
...
const sutra_en_6_8 = `1 Then the LORD said to Joshua, “Do not be afraid; do not be discouraged. Take the whole army with you, and go up and attack Ai. For I have delivered into your hands the king of Ai, his people, his city and his land.
...
const sutra_en_6_9 = `1 Now when all the kings west of the Jordan heard about these things—the kings in the hill country, in the western foothills, and along the entire coast of the Mediterranean Sea as far as Lebanon (the kings of the Hittites, Amorites, Canaanites, Perizzites, Hivites and Jebusites)—
...
const sutra_en_6_10 = `1 Now Adoni-Zedek king of Jerusalem heard that Joshua had taken Ai and totally destroyed it, doing to Ai and its king as he had done to Jericho and its king, and that the people of Gibeon had made a treaty of peace with Israel and had become their allies.
...
const sutra_en_6_11 = `1 When Jabin king of Hazor heard of this, he sent word to Jobab king of Madon, to the kings of Shimron and Akshaph,
...
const sutra_en_6_12 = `1 These are the kings of the land whom the Israelites had defeated and whose territory they took over east of the Jordan, from the Arnon Gorge to Mount Hermon, including all the eastern side of the Arabah:
...
const sutra_en_6_13 = `1 When Joshua had grown old, the LORD said to him, “You are now very old, and there are still very large areas of land to be taken over.
...
const sutra_en_6_14 = `1 Now these are the areas the Israelites received as an inheritance in the land of Canaan, which Eleazar the priest, Joshua son of Nun and the heads of the tribal clans of Israel allotted to them.
...
const sutra_en_6_15 = `1 The allotment for the tribe of Judah, according to its clans, extended down to the territory of Edom, to the Desert of Zin in the extreme south.
...
const sutra_en_6_16 = `1 The allotment for Joseph began at the Jordan, east of the springs of Jericho, and went up from there through the desert into the hill country of Bethel.
...
const sutra_en_6_17 = `1 This was the allotment for the tribe of Manasseh as Joseph’s firstborn, that is, for Makir, Manasseh’s firstborn. Makir was the ancestor of the Gileadites, who had received Gilead and Bashan because the Makirites were great soldiers.
...
const sutra_en_6_18 = `1 The whole assembly of the Israelites gathered at Shiloh and set up the tent of meeting there. The country was brought under their control,
...
const sutra_en_6_19 = `1 The second lot came out for the tribe of Simeon according to its clans. Their inheritance lay within the territory of Judah.
...
const sutra_en_6_20 = `1 Then the LORD said to Joshua:
...
const sutra_en_6_21 = `1 Now the family heads of the Levites approached Eleazar the priest, Joshua son of Nun, and the heads of the other tribal families of Israel
...
const sutra_en_6_22 = `1 Then Joshua summoned the Reubenites, the Gadites and the half-tribe of Manasseh
...
const sutra_en_6_23 = `1 After a long time had passed and the LORD had given Israel rest from all their enemies around them, Joshua, by then a very old man,
...
const sutra_en_6_24 = `1 Then Joshua assembled all the tribes of Israel at Shechem. He summoned the elders, leaders, judges and officials of Israel, and they presented themselves before God.
...
const sutra_en_6 = [sutra_en_6_1,sutra_en_6_2,sutra_en_6_3,sutra_en_6_4,sutra_en_6_5,sutra_en_6_6,sutra_en_6_7,sutra_en_6_8,sutra_en_6_9,sutra_en_6_10,
                sutra_en_6_11,sutra_en_6_12,sutra_en_6_13,sutra_en_6_14,sutra_en_6_15,sutra_en_6_16,sutra_en_6_17,sutra_en_6_18,sutra_en_6_19,sutra_en_6_20,
                sutra_en_6_21,sutra_en_6_22,sutra_en_6_23,sutra_en_6_24
                ];

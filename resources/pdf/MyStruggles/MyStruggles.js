const chapter_a_1 = `Today it seems to me providential that Fate should have chosen
...
that he would not return to his beloved native village until he had made something of himself.
...
had   any   serious   ideas   as  to   the   profession   I   should   one   day
pursue, my sympathies were in any case not in the direction of
my father's career. I believe that even then my oratorical talent
was   being   developed   in   the   form   of   more   or   less   violent
arguments with my schoolmates. I had become a little ringleader;
at school I learned easily and at that time very well, but was
otherwise rather hard to handle. Since in my free time I received
singing   lessons   in   the   cloister   at   Lambach,   I   had   excellent
opportunity to intoxicate myself with the solemn splendor of the
brilliant church festivals. As was only natural the abbot seemed
to me, as the village priest had once seemed to my father, the
highest and most desirable ideal. For a time, at least, this was the
case. But since my father, for understandable reasons, proved
unable to appreciate the oratorical talents of his pugnacious boy,
...
come across various books of a military nature among them a popular   edition   of   the   Franco­German   War   of   1870­7I   It
...
difference­between the Germans who fought these battles and
...
should   enhance   his   subsequent   achievement   in   his   eyes,
...
generation. It is a struggle for the soul of the child, and to the child its first appeal is addressed:
...
association; we emphasized  our convictions by wearing cornflowers and red lack, and gold colors; 'Heil ' was our greeting,
...
the   poison   of   foreign   nations   gnawed   at   the   body   of   our nationality, and even Vienna was visibly becoming more and
...
Francis   Ferdinand,   the   most   mortal   enemy   of   AustrianGermanism, to fall by the bullets which he himself had helped to
...
nation. Even then I had drawn the consequences from this realization
...
`;
const chapter_a_2 = `When my mother died, Fate, at least in one respect, had made its
decisions.
...
to   me   like   an   enchantment   out   of   ­The   Thousand­and­OneNights.
Now I was in the fair city for the second time, waiting with
burning impatience, but also with confident self­assurance, for
the result of my entrance examination. I was so convinced that I would be successful that when I received my rejection, it struck
...
required a high­school degree. I had none of all this. The fulfillment of my artistic dream seemed physically impossible.
...
position,   environment   and   tradition,   they   snatch   at   every livelihood   that   offers   itself,   grasp   at   every   sort   of   work,
...
in winter, is often difficult if not impossible. Even so, the first weeks are tolerable. He receives an unemployment benefit from
...
that the body gradually becomes accustomed to living on the fat of the land in good times and going hungry in bad times. Indeed,
...
Monday night, drunk and brutal, but always parted from his last cent, such scenes often occur that God have mercy!
...
sense. All the other things that the little fellow hears at home do not tend to increase his respect for his dear fellow men. Nothing
...
regime   which  I so   hated.  In  the  conviction  that  the  Austrian Empire   could   never   be   preserved   except   by   victimizing   its
...
morality­ all this written with the incredible gall that comes with prophetic   certainty­and   the   brutal   daily   press,   shunning   no
...
absurdity of this idea did not dawn on me because I saw no distinguishing feature but the strange religion. The fact that they
...
by the Reichstag angered me greatly because they emanated from a source which in my opinion really hadn't a leg to stand on,
...
scoundrel ends up like a garbage separator, splashing his filth in the face of humanity. And bear in mind that there is no limit to
...
me more akin to lies than honest truth; and the writers wereJews.
...
disapproval   never   struck   anyone   but   Germans.   The   gentle pinpricks   against   William   II   revealed   its   methods   by   their
...
encountered him in a place where I would least have expected to find him.
...
premise of its existence and its culture. As a foundation of the universe, this doctrine would bring about the end of any order
...
`;
const chapter_a_3 = `Today it is my conviction that in general, aside from cases of
...
While he himself has given up all idea of fighting seriously for his political revelations (a man does not die for something which
...
torch over the future of his country, then it was extinguished forever.
...
There was no longer any obstacle in the path of the further deGermanization of the state.
...
of enlightenment' and thus represents a sort of school for grownups. This instruction, however, is not in the hands of the state,
...
as to shoot off his mouth at committee meetings and congressesthat is, occasions where these pests are present in large numbers
­about a very special variety of 'honor,' to wit, the journalistic
variety,   which   the   assembled   rabble   gravely   and   mutually
confirm.
These   scum   manufacture   more   than   three   quarters  of  the   socalled   'public   opinion,'   from   whose   foam   the   parliamentarian
...
Czech countess, had been morganatically married to the Princeshe   came   from   circles   whose   anti­German   attitude   was
...
How easy it is for a tyranny to cover itself with the cloak of socalled 'legality' is shown most clearly and penetratingly by the
example of Austria.
...
To my mind, there were three causes for the collapse of the PanGerman movement in Austria.
...
these are present only to collect their attendance fees, and certainly not to be illuminated by the wisdom of this or that fellow
...
As soon as the Pan­German movement sold its soul to parliament,   it   attracted   'parliamentarians'   instead   of   leaders   and
fighters.
...
lay, particularly in Schonerer's opinion, in the fact that the directing body of the Catholic Church was not in Germany, and
...
because the law of democracy seems holier to such a principlemonger   than   the   welfare   of   a   nation.   The   one   will   therefore
...
artisans,   it   obtained   a   following   as   enduring   as   it   was   selfsacrificing. It avoided any struggle against a religious institution
...
truly great central opponent. It recognized the value of largescale   propaganda   and   was   a   virtuoso   in   influencing   the
...
racial questions could keep them in a party which was not antiGerman to begin with. If Austria were to be saved, this was
...
`;
const chapter_a_4 = `In the spring of 1912 I came at last to Munich.
...
How   different   it   was   if   you   left   Vienna,   or   rather   GermanAustria, and went to the Slavic provinces of the Empire ! You
...
diplomatic blindness. But in Austria things were not a hair'sbreadth different.
In   Austria   the   only   exponents   of   the   alliance   idea   were   the
Habsburgs and the Germans. The Habsburgs, out of calculation
and  compulsion;  the  Germans,   from  good  faith  and   politicalstupidity. From good faith, for they thought that by the Triple
...
could also silence any embarrassing voice among the AustrianGermans   which   might   rise   in   German   quarters   against
...
particularly to withdraw the soil from widespread speculation,
best can never suffice to secure the future of the nation without
the acquisition of new soil.
...
essential factor for determining its outward security. The greater
the quantity of space at the disposal of a people, the greater its
natural protection; for military decisions against peoples living in
a small restricted area have always been obtained more quickly
and hence more easily, and in particular more effectively and
completely than can, conversely, be possible against territorially
extensive states. In the size of a state's territory there always lies
a certain protection against frivolous attacks, since success can
be achieved only after hard struggles, and therefore the risk of a
rash assault will seem too great unless there are quite exceptional
grounds for it. Hence the very size of a state offers in itself a
basis for more easily preserving the freedom and independence
of a people, while, conversely, the smallness of such a formation
is a positive invitation to seizure.
Actually the two first possibilities for creating a balance between
the   rising   population   and   the   stationary   amount   of   soil   were
rejected in the so­called national circles of the Reich. The reasons
for this position were, to be sure, different from those above
mentioned:   government   circles   adopted   a   negative   attitude
...
power and determination to put an end to the process of deGermanization on its own immediate borders. If Germany did not
...
Russia. But then we had dauntlessly to draw the consequencesand, above all, abandon Austria in all haste.
...
is just as large as it is incomprehensible, particularly to our socalled ' statesmen ' of today. That is why they think they can
...
these   qualities,   and   in   the   subsequent   struggle   for   selfpreservation those nations will be defeated­ that is, will fall a
...
only   remaining   solution   to   the   riddle   became   to   an   everincreasing degree that power which, from an entirely different
...
`;
const chapter_a_5 = `As a young scamp in my wild years, nothing had so grieved me
...
struggle the necessary grave undertone entered into the ecstasyof an overflowing enthusiasm; for this knowledge alone made the
...
Marxism, whose goal is and remains the destruction of all nonJewish national states, was forced to look on in horror as, in the
...
`;
const chapter_a_6 = `Ever since I have been scrutinizing political events, I have taken
...
practically unknown to the bourgeois parties. Only the ChristianSocial movement, especially in Lueger's time, achieved a certain
...
question of destiny, 'to be or not to be,' cries out for a solutionthen all considerations of humanitarianism or aesthetics crumble
...
aimed at the emotions and only to a very limited degree at the socalled intellect.
...
particularly a people that suffers from the mania of objectivity as
much as the Germans. For, after all this, everyone will take the
greatest pains to avoid doing the enemy any injustice, even at the
peril   of   seriously   besmirching   and   even   destroying   his   own
people and country.
...
and actions far less than emotion and feeling. And this sentiment
is not complicated, but very simple and all of a piece. It does not
have multiple shadings; it has a positive and a negative; love or
hate, right or wrong, truth or lie never half this way and half that
way, never partially, or that kind of thing.
...
adapted to this condition. As ruthless as it was brilliant, it created
the preconditions for moral steadfastness at the front, even in the
face   of   the   greatest   actual   defeats,   and   just   as   strikingly   it
pilloried   the   German   enemy   as   the   sole   guilty   party   for   the
outbreak of the War: the rabid, impudent bias and persistence
with   which   this   lie   was   expressed   took   into   account   the
...
success.   In   its   inner   ambiguity   alone,   it   bore   the   germ   of
...
our feather­brained 'statesmen' could have dared to hope that this
...
this   world,   persistence   is   the   first   and   most   important
...
too old­fashioned, too hackneyed, too out­of­date, etc. They are
...
`;
const chapter_a_7 = `With the year 1915 enemy propaganda began in our country,
...
the far­reaching arm of the heavy long­range batteries began to
...
the   whole   world­to   whom   this   was   very   well   known­   was,
...
troops­yet not a single step was taken against it from above. This
...
hard to describe­it was more like hell than war.
...
barbed­wire entanglement in order to be sent to the hospital; in
...
considered   a   symptom   of   inner   weakness   and   narrowmindedness.   The   offices   were   filled   with   Jews.   Nearly   every
...
soon for the lack of munitions as such­as the plan had been­ to
...
railways,   this   stream   was   almost   without   end­but   for   every
...
despair of the Allied front­in the time that followed, thousands of
...
had an interest in holding out any longer­all this came from the
...
home from their second­line base. Now they raised the red rag in
the homeland.
...
dignified old gentleman seemed all a­tremble as he informed us
...
and­here he began to sob gently to himself­in the little hall the
...
previous   enemies­I   could   stand   it   no   longer.   It   became
...
creeping gas­in the last days of the dreadful struggle­ attacked
...
when with sore heart she let her best­loved boys march off, never
...
`;
const chapter_a_8 = `At the end of November, 1918, I returned to Munich. Again I
...
the   state   and   the   nation   owing   to   its   simple   instinct   of   selfpreservation or of reproduction. This dependence of capital on
...
though human thought can apprehend truths and set up crystalclear   aims,   complete   fulfillment   will   fail   due   to   the   general
...
person is almost never found. This is especially true of the socalled 'successful' politician of small format, whose activity for
...
`;
const chapter_a_9 = `One day I received orders from my headquarters to find out what
...
Feder's   arguments   and   then­after   Feder   replied   very   wellsuddenly appealed to 'the facts,' but not without recommending
...
&shyp;   for   which   the   treasurer   received   a   vote   of   general
...
Party, and then­then there was a long deliberation with regard to
the answers to be made.
...
there was nothing, no program, no leaflet, no printed matter at
all, no membership cards, not even a miserable rubber stamp,
only obvious good faith and good intentions.
I had stopped smiling, for what was this if not a typical sign of
the complete helplessness and total despair of all existing parties,
their programs, their purposes, and their activity? The thing that
drove these few young people to activity that was outwardly so
absurd was only the emanation of their inner voice, which more
...
revulsion   toward   men   who   start   everything   and   never   carry
anything out These jacks­of­all­trades were loathsome to me. I
...
nation   could   some   day   be   organized,   but   never   through   the
...
the   nameless,   that   I   was   one   of   the   millions   whom   chance
...
people   the   biggest   empty­head,   if   he   is   wrapped   in   enough
...
`;
const chapter_a_10 = `The   extent   of   the   fall   of   a   body   is  always  measured   by   the
...
understood that here, too, economics is only of second or thirdrate importance, and the primary role falls to factors of politics,
...
sections   of   the   people   against   one   another,   the   bourgeoisdemocratic   papers   knew   how   to   give   an   appearance   of   their
...
Particularly with regard to syphilis, the attitude of the leadership
of   the   nation   and   the   state   can   only   be   designated   as   total
capitulation. To fight it seriously, they would have had to take
somewhat   broader   measures   than   was   actually   the   case.   The
invention   of   a   remedy   of   questionable   character   and   its
commercial exploitation can no longer help much against this
plague.   Here   again   it   was   only   the   fight   against   causes   that
mattered and not the elimination of the symptoms. The cause
lies, primarily, in our prostitution of love. Even if its result were
not this frightful plague,  it would nevertheless  be profoundly
injurious to man, since the moral devastations which accompany
this degeneracy suffice to destroy a people slowly but surely.
This Jewification of our spiritual life and mammonization of our
mating instinct will sooner or later destroy our entire offspring,
for the powerful children of a natural emotion will be replaced by
the   miserable   creatures   of   financial   expediency   which   is
becoming more and more the basis and sole prerequisite of our
marriages. Love finds its outlet elsewhere.
Here, too, of course, Nature can be scorned for a certain time, but
her vengeance will not fail to appear, only it takes a time to
...
augment the offspring of His Highness­and, indeed, the offspring
look it. In both cases complete degeneration is the consequence.
Today our bourgeoisie strive to go the same road, and they will
end up at the same goal.
Hastily and indifferently, people tried to pass by the unpleasant
truths, as though by such an attitude events could be undone. No,
the fact that our big city population is growing more and more
prostituted in its love life cannot just be denied out of existence;
it   simply   is   so.   The   most   visible   results   of   this   mass
contamination   can,   on   the   one   hand,   be   found   in   the   insane
asylums, and on the other, unfortunately, in our­children. They in
...
opportunity for early marriage as compatible with human natureparticularly for the man, as the woman in any case is only the
passive part.
...
guide it, is the task of education, and not just the pumping of socalled wisdom. We must also do away with the conception that
...
fifteen­year­olds. Who will be surprised that even in these agegroups   syphilis   begins   to   seek   its   victims?   And   is   it   not
...
prospect   of   success.   But   here,   too,   there   must   be   no   halfmeasures; the gravest and most ruthless decisions will have to be
...
the time. That is why, beginning in education, everyone is halfhearted and vacillating, shunning responsibility and thus ending
...
mores, without which assuredly hundreds of thousands of wellbred people would live sensibly and reasonably but millions of
...
struck   from   the   hand   of   the   nation   its   weapon   of   selfpreservation,   the   only   defense   of   our   people's   freedom   and
...
chairs   for   a   gang   of   unscrupulous   climbers   and   job­huntersanyone   who   contemplates   all   this   will   understand   that   these
...
The young man who practiced obedience during this time couldthen learn to command. By his very step you could recognize the
...
Ability and competence were replaced by party ties and a selfreliant, independent character became more of a hindrance than a
help.
...
`;
const chapter_a_11 = `There are some truths which are so obvious that for this very
...
lack  this knowledge­quite  aside  from  all  this,  an   idea  cannot
...
intended,   or   so   at   least   our   German   visionaries   believed­and
...
technology and inventions­is only the creative product of a few
...
live.
Even if this were hard­that is how it is ! Assuredly, however by
...
the other beings of this earth. Exclude him­and perhaps after a
...
technology, just as much as in Europe. Only the outward form­in
...
the fact that practically none of them were originally culturefounding, but almost always culture­bearing.
...
the   most   primitive   living   creatures   the   instinct   of   selfpreservation   does   not   go   beyond   concern   for   their   own   ego.
...
fights   only   for   his  own   life.   As  long   as   the   instinct   of   selfpreservation expresses itself in this way, every basis is lacking
for the formation of a group, even the most primitive form of
family.  Even  a  community  between  male   and  female   beyond
pure   mating,   demands   an   extension   of   the   instinct   of   selfpreservation,  since  concern and struggle for the ego are now
...
the   service   of   the   community.   In   him   the   instinct   of   selfpreservation   has reached   the  noblest  form,  since  he  willingly
...
In   hardly   any   people   in   the   world   is   the   instinct   of   selfpreservation   developed   more   strongly   than   in   the   so­called
...
people, finally, has gone through greater upheavals than this oneand   nevertheless   issued   from   the   mightiest   catastrophes   of
...
Since the Jew­for reasons which will at once become apparentwas never in possession of a culture of his own, the foundations
...
absence of all sense of self­sacrifice, expressing itself in their
...
for preserving and increasing a race­is completely unlimited as to
territory. For a state formation to have a definite spatial setting
always presupposes an idealistic attitude on the part of the staterace, and especially a correct interpretation of the concept of
...
No, the Jew possesses no culture­creating force of any sort, since
...
wandering,  provided  that  his  thousand­year­old  education   and
...
very hard to drive him out. His extension to ever­new countries
...
of the world; in other words, with non­Jews. But even here it is
...
thousand­year­old mercantile dexterity he is far superior to the
...
gradually increases to open hatred. His blood­sucking tyranny
...
sometimes flares high against the eternal blood­sucker, it does
...
interest and compound interest. A true blood­sucker that attaches
...
reason. Thus­despite all the shameful actions of the courts­the
...
man can change his language without any trouble­that is, he can
...
secretary or higher police official is also self­evident, for there is
...
him   for   religious   tolerance­and   in   Freemasonry,   which   has
...
of course­like other peoples as well­but even in their gestures,
...
compatible with his requirements; for it excludes the personalityand   puts   in   its   place   the   majority   characterized   by   stupidity,
...
workers­particularly of the state­as a new class. They, too, were
...
fourteen­or even fifteen­hour working day had been bearable, it
...
While   the   bourgeoisie   is   not   at   all   concerned   about   this   allimportant question, but indifferently lets things slide, the Jew
...
the domination of the inferior being­and this is the Jew.
...
selfpreservation begun by Freemasonry in the circles of the socalled intelligentsia is transmitted to the broad masses and above
...
high­handed arrogance to inferiors distinguish this class to the
same degree as a narrow­mindedness that often cries to high
...
so­called national bourgeoisie, blinded by financial interests, sets
...
leader of the trade­union movement, all the more easily as he is
...
conscience   can   prevent   him   as   a   leader   of   the   trade­union
...
trade­union organization finally obtains the agitational institution
...
selfpreservation,   destroys   the   foundations   of   all   national   selfmaintenance and defense, destroys faith in the leadership, scoffs
...
wants to respect the Nature­given qualities of its being which
...
influence exerted on grown­ups by the press, etc., everywhere
...
national body­yes, even a certain section of the leaders­were bad
...
hence also outward collapse. All the successes of the so­called
bourgeois parties were worthless, not only because even with socalled bourgeois electoral victories they were unable to halt the
...
the   national   instinct   of   self­preservation   in   face   of   the
progressing pacifist­Marxist paralysis of our national body. Since
...
`;
const chapter_a_12 = `If at the end of this volume I describe the first period in the
...
represents   a   question   of   regaining   our   political   will   for   selfpreservation, it is also clear that this cannot be done by winning
...
the function of organization is the transmission of a definite ideawhich always first arises from the brain of an individual ­to a
...
and is replaced by the necessary evil of organization. Little subgroups are formed which in the political movement, for example,
...
party leader he had one exceedingly serious drawback: he was no
speaker   for   the   masses.   As   scrupulously   conscientious   and
...
schooling   which   was   capable   of   turning   uncertain   and   soft
natures into men. Thus both men were not made of stuff which
would have enabled them not only to bear in their hearts fanatical
faith in the victory of a movement, but also with indomitable
energy and will, and if necessary  with brutal ruthlessness,  to
sweep aside any obstacles which might stand in the path of the
rising new idea. For this only beings were fitted in whom spirit
and body had acquired those military virtues which can perhaps
best   be   described   as   follows:   swift   as   greyhounds,   tough   as
leather, and hard as Krupp steel.

At that time I myself was still a soldier. My exterior and interior
had been whetted and hardened for well­nigh six years, so that at
first   I   must   have   seemed   strange   in   this   circle.   I,   too,   had
forgotten how to say: 'that's impossible,' or 'it won't work'; 'we
can't risk that,' 'that is too dangerous,' etc.
For of course the business was dangerous. Little attention as the
Reds paid to one of your bourgeois gossip clubs whose inner
innocence   and   hence   harmlessness   for   themselves   theyknew
better than its own members, they were determined to use every
means to get rid of a movement which did seem dangerous to
them. Their most effective method in such cases has at all times
...
publicly   invite   attendance   was   simply   impossible.   The
...
party, as long as this goal has not been achieved.  It is hairsplitting   and   shadow­boxing   when   some   antiquated   folkish
...
for the same idea. Anyone who fights for forty years for a socalled idea without being able to bring about even the slightest
...
which only pretend to for certain reasons. Especially with the socalled religious reformers on an old Germanic basis, I always
...
The first expression kept away the antiquity enthusiasts, the bigmouths and superficial proverb­makers of the so­called folkish
...
not only cowards, but they are also always incompetents and donothings. A man who knows a thing, who is aware of a given
...
const chapter_a = [
    {
        id:1,
        title_cn:" ",
        title_en:"In the House of My Parents ",
        content:chapter_a_1
    },
    {
        id:2,
        title_cn:" ",
        title_en:"Years of Study and Suffering",
        content:chapter_a_2
    },{
        id:3,
        title_cn:" ",
        title_en:"General Political Considerations Based on My Vienna Period",
        content:chapter_a_3
    },{
        id:4,
        title_cn:" ",
        ...
        id:5,
        title_cn:" ",
        title_en:"The world War",
        content:chapter_a_5
    },{
        id:6,
        title_cn:" ",
        title_en:"War Propaganda",
        content:chapter_a_6
    },{
        id:7,
        title_cn:" ",
        title_en:"The Revolution",
        content:chapter_a_7
    },{
        id:8,
        title_cn:" ",
        title_en:"The Beginning of My Political Activity",
        content:chapter_a_8
    },{
        id:9,
        title_cn:" ",
        title_en:"The German Workers' Party",
        content:chapter_a_9
    },{
        id:10,
        title_cn:" ",
        title_en:"Causes of the Collapse",
        content:chapter_a_10
    },{
        id:11,
        title_cn:" ",
        title_en:"Nation and Race",
        content:chapter_a_11
    },{
        id:12,
        title_cn:" ",
        title_en:"The First Period of Development of the National Socialist German Workers' Party",
        content:chapter_a_12
    }
];



const chapter_b_1 = `On February 24th, 1920, the first great mass meeting under the
auspices of the new movement took place. In the Banquet Hall of
the   Hofbräuhaus   in   Munich   the   twenty­five   theses   which
...
timid   and   feckless   bourgeoisie.   This   force   was   destined   to
...
significance and support which are necessary pre­requisites in
...
followers,   that   here   it   was   not   a   case   of   introducing   a   new
...
party wagon they begin to paint the shafts with new colours. On
such occasions the party astrologists and horoscope readers, the
so­called 'experienced men' and 'experts', come forward. For the
most   part   they   are   old   parliamentary   hands   whose   political
schooling has furnished them with ample experience. They can
remember former occasions when the masses showed signs of
losing patience and they now diagnose the menace of a similar
situation arising. Resorting to their old prescription, they form a
'committee'. They go around among the darling public and listen
to what is being said. They dip their noses into the newspapers
and gradually begin to scent what it is that their darlings, the
broad masses, are wishing for, what they reject and what they are
hoping for. The groups that belong to each trade or business, and
even office employees, are carefully studied and their innermost
desires are investigated. The 'malicious slogans' of the opposition
from which danger is threatened are now suddenly looked upon
as worthy  of  reconsideration,   and  it  often  happens  that  these
slogans, to the great astonishment of those who originally coined
and circulated them, now appear to be quite harmless and indeed
are to be found among the dogmas of the old parties.
So the committees meet to revise the old programme and draw
up a new one.
For   these   people   change   their   convictions   just   as   the   soldier
changes his shirt in war – when the old one is bug­eaten. In the
new programme everyone gets everything he wants. The farmer
is assured that the interests of agriculture will be safeguarded.
The industrialist is assured of protection for his products. The
consumer is assured that his interests will be protected in the
market   prices.   Teachers   are   given   higher   salaries   and   civil
servants  will  have   better   pensions.   Widows  and   orphans  will
receive   generous   assistance   from   the   State.   Trade   will   be
promoted. The tariff will be lowered and even the taxes, though
they cannot be entirely abolished, will be almost abolished. It
sometimes happens that one section of the public is forgotten or
that   one   of   the   demands   mooted   among   the   public   has   not
reached the ears of the party. This is also hurriedly patched on to
the whole, should there be any space available for it: until finally
it is felt that there are good grounds for hoping that the whole
normal host of philistines, including their wives, will have their
anxieties laid to rest and will beam with satisfaction once again.
And so, internally armed with faith in the goodness of God and
the impenetrable stupidity of the electorate, the struggle for what
is called 'the reconstruction of the Reich' can now begin.
When the election day is over and the parliamentarians have held
their last public meeting for the next five years, when they can
leave their job of getting the populace to toe the line and can now
devote themselves to higher and more pleasing tasks – then the
programme   committee   is   dissolved   and   the   struggle   for   the
progressive reorganization of public affairs becomes once again a
business   of   earning   one's   daily   bread,   which   for   the
parliamentarians means merely the attendance that is required in
order to be able to draw their daily remunerations. Morning after
morning the honourable deputy wends his way to the House, and
though he may not enter the Chamber itself he gets at least as far
as the front hall, where he will find the register on which the
names of the deputies in attendance have to be inscribed. As a
...
hands, backed by a mob of loafers, deserters, political placehunters and Jewish dilettanti. That was a blow in the face for that
...
madness   of   thinking   that   the   Jewish   drive   towards   worldconquest   can   be   effectually   opposed   by   means   of   Western
Democracy.
...
`;
const chapter_b_2 = `By 1920­1921 certain circles belonging to the present outlived
...
madness of human brains, a positively dog­like adoration of socalled state authority is needed. In the minds of these people the
...
Not only in Austria, however, but also in the Reich, these socalled national circles were, and still are, under the influence of
...
character, a process which has resulted in our German hyperindividualism,   though   this   latter   characteristic   is   even   now
frequently praised.
...
effectively. It is therefore outrageously unjust to speak of the preChristian Germans as barbarians who had no civilization. They
...
in the single districts. Beside the Nordic type we find the EastEuropean   type,   beside   the   Eastern   there   is   the   Dinaric,   the
...
herd faces the enemy. What we understand by the word hyperindividualism   arises   from   the   fact   that   our   primordial   racial
...
from the fact that there was no all­round assimilation is to be
...
people's   instinct   for   self­preservation   on   this   earth.   For   these
...
lazy­minded and indifferent rather than evil, and those whose
self­interest leads them to uphold the present state of affairs. On
the   apparent   hopelessness   of   our   great   struggle   is   based   the
magnitude of our task and the possibilities of success. A battlecry which from the very start will scare off all the petty spirits, or
...
of  the  mongrel.  The  later  products  of  cross­breeding  have   to
...
lack definite will­power and vigorous vital energies owing to the
...
procreation,   thus   impeding   the   fertility   of   cross­breeds   and
...
this cross­breeding would be weaker than those of the people
...
cross­breed   among   themselves,   the   latter   will   either   die   out
...
essentially   inferior   to   those   which   the   first   cross­breeds
...
of this cross­breed has not retained within itself some sort of
...
highest   importance   to   the   development   of   character,   hand­inhand   with   physical   training.   Many   more   defects   which   our
...
Extreme importance should be attached to the training of willpower and the habit of making firm decisions, also the habit of
...
utilized   for   physical   training   and   character   training,   in   willpower, the capacity for making practical judgments, decisions,
etc.
...
const chapter_all = [  chapter_a,  chapter_b ];

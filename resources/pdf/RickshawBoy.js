const chapter_1= `The person we want to introduce is Happy Boy and not
...
`;
const chapter_2= `BECAUSE of Ills high spirits, Happy Boy lost some of
    his temerity: after he had bought his own rickshaw he
    ...
    Though it was already the season for the opening of the
    ...
    Where was he? It was a question that he couldn’t have answered

    26



    properly himself. For the past days he had followed the
    ...
    If it happened that the troops retreated again into tlie mountains,
    he would be in danger of starving to death even if he did
...
`;
const chapter_3= `WHEN he had already run twenty or thirty paces away.
...
`;
const chapter_4= `APPY BOY lay for three days in a little inn in the tovm
   ...
   When he had rested for a long time, he went up to the head
   ...
   ''Rickshaw?'' Happy Boy spat on the ground.
   ...
   `;
const chapter_5= `IN real truth, Liu did not spread the story of the camels
     abroad for Happy Boy, but it very quicly reached the city
  ...
  him . . .
`;
const chapter_6= `IN the early autumn night the starlight was so bright that
...
`;
const chapter_7= `
 BOY went to live and work in the Ts’ao household.
 Toward Tiger Girl he felt a certain sense of shame.
 ...
 sleep.
`;
const chapter_8= `Mr. Tsao had the rickshaw repaired, and didn't take
                  the cost out of Happy Boy's wages. Mrs. Ts'ao gave
     ...
     would turn rotten!
`;
const chapter_9= `HAPPY BOY had hardly the strength to step across the
   threshold. His head swam with befuddlement and his
...
`;
const chapter_10= `  A FIGHTING cricket that has lost one of its big legs in
...
`;
const chapter_11= `  WHENEVER he thought of the old man and Little
...
`;
const chapter_12= `  Happy BOY wanted to find a place to sit down and go
  over the whole story in his mind, to get the things that
...
`;
const chapter_13= `
  BECAUSE the snow caught the light and sent it glisten-
...
const chapter_14= `
  ...
  to say.
`;
const chapter_15= ` REGARDING the use of violence. Happy Boy could not
  hit an old man nor could he raise his fist against a
  ...
  feet and run away. On account, howewer, of the scene that was
 ...
 `;
const chapter_16= `IT was already the time of the festival of the fifteenth day
...
`;
const chapter_17= `
  SLOWLY Happy Boy managed to piece together, by ask-
...
`;
const chapter_18= ` WHEN the year had reached the sixth month, the courtyard
  was hushed and deserted in the daytime. The chil-
...
`;
const chapter_19= `
  FOR two days and two nights Happy Boy slept a deep, heavy
...
`;
const chapter_20= `
  HAPPY BOY sold his ricicshaw !
  Nor could his hand close over the money as it slipped
...
`;
const chapter_21= `  BECAUSE, at the time when the chrysanthemum flowers
...
`;
const chapter_22= `
  WHEN he had first come to Peking, the one hope that
...
`;
const chapter_23= `
  HAPPY BOY forgot where he was going. His head thrown
  backy his hands clenched tightly over the shafts of his
...
`;
const chapter_24= `
  The year had come again to the festival of the Imperial
  Sacrifices, and again the weather had become very warm.
  ...
  was alive. He was alive. They were free.`;
